    ...
    <GraphPaperBackground>
      ...
      <Unauthenticated>
        <div className="min-h-screen flex items-center justify-center">
          <div className="relative max-w-md w-full space-y-8 p-8 bg-black border-2 border-[#4CAF50] rounded-lg shadow-neo-glow-border transition-all duration-300 font-sans group hover:shadow-neo-glow-dark">
            {/* Border glow effect */}
