...
export function NeobrutalistSidebar({ activeView, onViewChange }: NeobrutalistSidebarProps) {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r-4 border-black dark:border-gray-700">
      <SidebarHeader className="border-b-4 border-black bg-yellow-300 dark:border-gray-700 dark:bg-gray-800">
      ...
      <SidebarContent className="bg-white dark:bg-gray-900">
        <SidebarGroup>
          <SidebarGroupLabel className="text-black font-bold dark:text-gray-300">Navigation</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {items.map((item) => (
      ...
      <SidebarFooter className="border-t-4 border-black bg-blue-300 dark:border-gray-700 dark:bg-gray-800">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton 
              size="lg" 
            ...
            >
              <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-black text-white border-2 border-white dark:bg-gray-700 dark:text-gray-200 dark:border-gray-500">
              ...
              <ChevronUp className="ml-auto size-4 dark:text-gray-300" />
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarFooter>
