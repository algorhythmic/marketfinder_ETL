              ...
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span className={`px-2 py-1 rounded border-2 border-black text-xs font-bold uppercase tracking-wider ${
                    group.isVerified ? "bg-green-300 text-green-800 dark:bg-green-700 dark:text-green-200 dark:border-green-500" : "bg-yellow-300 text-yellow-800 dark:bg-yellow-600 dark:text-yellow-100 dark:border-yellow-500"
                  }`}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {group.markets.filter((market): market is NonNullable<typeof market> => market !== null).map((market) => (
                    <div key={market._id} className="p-3 bg-gray-50 rounded-lg border-2 border-black shadow-[2px_2px_0px_0px_#000] dark:bg-gray-700 dark:border-gray-600 dark:shadow-[2px_2px_0px_0px_#000]">
