...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-2 border-black shadow-[4px_4px_0px_0px_#000] active:shadow-[2px_2px_0px_0px_#000] active:translate-x-[2px] active:translate-y-[2px] dark:border-gray-600 dark:shadow-[4px_4px_0px_0px_#000] dark:active:shadow-[2px_2px_0px_0px_#000] dark:focus-visible:ring-gray-500 dark:ring-offset-gray-900",
  // Note: #1f2937 is slate-800. dark:border-gray-600, dark:focus-visible:ring-gray-500, dark:ring-offset-gray-900 (assuming dark page bg)
  {
    variants: {
      variant: {
