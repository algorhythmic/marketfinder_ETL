        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-black rounded-md px-3 py-2 text-sm font-medium shadow-[4px_4px_0px_0px_#000] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 dark:shadow-[4px_4px_0px_0px_#000] dark:focus:ring-blue-400 dark:focus:border-blue-400"
            />
          </div>
          <div>
            ...
            <select
              ...
              className="w-full border-2 border-black rounded-md px-3 py-2 text-sm font-medium shadow-[4px_4px_0px_0px_#000] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:shadow-[4px_4px_0px_0px_#1f2937] dark:focus:ring-blue-400 dark:focus:border-blue-400"
            >
          ...
          <div key={market._id} className="bg-white rounded-lg border-4 border-black p-6 shadow-[8px_8px_0px_0px_#000] hover:shadow-[4px_4px_0px_0px_#000] hover:translate-x-[4px] hover:translate-y-[4px] transition-all dark:bg-gray-800 dark:border-gray-700 dark:shadow-[8px_8px_0px_0px_#000] dark:hover:shadow-[4px_4px_0px_0px_#000]">
            <div className="flex justify-between items-start mb-4">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                  <span className="bg-blue-300 text-blue-800 px-2 py-1 rounded border-2 border-black text-xs font-bold uppercase tracking-wider dark:bg-blue-700 dark:text-blue-200 dark:border-blue-500">
                    {market.category || "Uncategorized"}
                  </span>
                  <span className={`px-2 py-1 rounded border-2 border-black text-xs font-bold uppercase tracking-wider ${
                    market.status === "active" ? "bg-green-300 text-green-800 dark:bg-green-700 dark:text-green-200 dark:border-green-500" :
                    market.status === "closed" ? "bg-yellow-300 text-yellow-800 dark:bg-yellow-600 dark:text-yellow-100 dark:border-yellow-500" :
            ...
            <div className="space-y-2 mb-4">
              {market.outcomes.map((outcome) => (
                <div key={outcome.id} className="flex justify-between items-center p-3 bg-gray-50 rounded border-2 border-black dark:bg-gray-700 dark:border-gray-600">
                  <span className="text-sm font-bold text-gray-900 dark:text-white">{outcome.name}</span>
                  <div className="text-right">
                    <span className="text-sm font-bold text-gray-900 bg-yellow-300 px-2 py-1 rounded border border-black dark:text-gray-900 dark:bg-yellow-400 dark:border-gray-800">
            ...
            {/* Market Info */}
            <div className="flex justify-between items-center text-sm text-gray-500 border-t-2 border-black pt-4 dark:text-gray-400 dark:border-gray-600">
